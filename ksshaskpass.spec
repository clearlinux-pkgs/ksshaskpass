...
Version  : 6.0.5
Release  : 98
URL      : https://download.kde.org/stable/plasma/6.0.5/ksshaskpass-6.0.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.5/ksshaskpass-6.0.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.5/ksshaskpass-6.0.5.tar.xz.sig
...
%setup -q -n ksshaskpass-6.0.5
cd %{_builddir}/ksshaskpass-6.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716386989
mkdir -p clr-build
pushd clr-build
