...
Version  : 5.23.3
Release  : 54
URL      : https://download.kde.org/stable/plasma/5.23.3/ksshaskpass-5.23.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.23.3/ksshaskpass-5.23.3.tar.xz
...
%prep
%setup -q -n ksshaskpass-5.23.3
cd %{_builddir}/ksshaskpass-5.23.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636492179
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ksshaskpass-5.23.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/ksshaskpass/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
