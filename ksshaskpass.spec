...
Source0  : https://download.kde.org/stable/plasma/6.0.3/ksshaskpass-6.0.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.3/ksshaskpass-6.0.3.tar.xz.sig
...
%prep
%setup -q -n ksshaskpass-6.0.3
cd %{_builddir}/ksshaskpass-6.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711666978
mkdir -p clr-build
pushd clr-build
