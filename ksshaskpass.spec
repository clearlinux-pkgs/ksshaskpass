...
Version  : 5.25.3
Release  : 66
URL      : https://download.kde.org/stable/plasma/5.25.3/ksshaskpass-5.25.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.25.3/ksshaskpass-5.25.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.3/ksshaskpass-5.25.3.tar.xz.sig
...
%prep
%setup -q -n ksshaskpass-5.25.3
cd %{_builddir}/ksshaskpass-5.25.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657634578
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ksshaskpass-5.25.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/ksshaskpass/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
