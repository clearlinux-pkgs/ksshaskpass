...
Version  : 6.0.0
Release  : 89
URL      : https://download.kde.org/stable/plasma/6.0.0/ksshaskpass-6.0.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.0/ksshaskpass-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.0/ksshaskpass-6.0.0.tar.xz.sig
...
%prep
%setup -q -n ksshaskpass-6.0.0
cd %{_builddir}/ksshaskpass-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709256150
mkdir -p clr-build
pushd clr-build
