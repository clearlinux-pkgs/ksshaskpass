...
Source0  : https://download.kde.org/stable/plasma/5.27.8/ksshaskpass-5.27.8.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.8/ksshaskpass-5.27.8.tar.xz.sig
...
%prep
%setup -q -n ksshaskpass-5.27.8
cd %{_builddir}/ksshaskpass-5.27.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694537236
mkdir -p clr-build
pushd clr-build
