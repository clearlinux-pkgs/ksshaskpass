...
Version  : 6.0.4
Release  : 96
URL      : https://download.kde.org/stable/plasma/6.0.4/ksshaskpass-6.0.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.4/ksshaskpass-6.0.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.4/ksshaskpass-6.0.4.tar.xz.sig
...
%setup -q -n ksshaskpass-6.0.4
cd %{_builddir}/ksshaskpass-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713287182
mkdir -p clr-build
pushd clr-build
