...
Source0  : https://download.kde.org/stable/plasma/5.20.5/ksshaskpass-5.20.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.20.5/ksshaskpass-5.20.5.tar.xz.sig
...
%prep
%setup -q -n ksshaskpass-5.20.5
cd %{_builddir}/ksshaskpass-5.20.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609867340
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ksshaskpass-5.20.5/COPYING %{buildroot}/usr/share/package-licenses/ksshaskpass/0b184ad51ba2a79e85d2288d5fcf8a1ea0481ea4
pushd clr-build
%make_install
popd
