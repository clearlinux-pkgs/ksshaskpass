...
Version  : 5.26.3
Release  : 72
URL      : https://download.kde.org/stable/plasma/5.26.3/ksshaskpass-5.26.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.3/ksshaskpass-5.26.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.3/ksshaskpass-5.26.3.tar.xz.sig
...
%prep
%setup -q -n ksshaskpass-5.26.3
cd %{_builddir}/ksshaskpass-5.26.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667919448
mkdir -p clr-build
pushd clr-build
