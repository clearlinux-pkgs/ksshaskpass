...
Source0  : https://download.kde.org/stable/plasma/5.20.3/ksshaskpass-5.20.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.20.3/ksshaskpass-5.20.3.tar.xz.sig
...
%prep
%setup -q -n ksshaskpass-5.20.3
cd %{_builddir}/ksshaskpass-5.20.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605052680
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ksshaskpass-5.20.3/COPYING %{buildroot}/usr/share/package-licenses/ksshaskpass/0b184ad51ba2a79e85d2288d5fcf8a1ea0481ea4
pushd clr-build
%make_install
popd
