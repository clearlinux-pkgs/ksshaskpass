...
Version  : 5.26.4
Release  : 73
URL      : https://download.kde.org/stable/plasma/5.26.4/ksshaskpass-5.26.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.4/ksshaskpass-5.26.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.4/ksshaskpass-5.26.4.tar.xz.sig
...
%prep
%setup -q -n ksshaskpass-5.26.4
cd %{_builddir}/ksshaskpass-5.26.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669814406
mkdir -p clr-build
pushd clr-build
