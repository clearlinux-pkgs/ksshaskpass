...
Source0  : https://download.kde.org/stable/plasma/5.24.1/ksshaskpass-5.24.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.24.1/ksshaskpass-5.24.1.tar.xz.sig
...
%prep
%setup -q -n ksshaskpass-5.24.1
cd %{_builddir}/ksshaskpass-5.24.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645025550
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ksshaskpass-5.24.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/ksshaskpass/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
