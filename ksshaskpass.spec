...
Source0  : https://download.kde.org/stable/plasma/5.26.5/ksshaskpass-5.26.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.5/ksshaskpass-5.26.5.tar.xz.sig
...
%prep
%setup -q -n ksshaskpass-5.26.5
cd %{_builddir}/ksshaskpass-5.26.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673285617
mkdir -p clr-build
pushd clr-build
