...
Version  : 5.14.0
Release  : 4
URL      : https://download.kde.org/stable/plasma/5.14.0/ksshaskpass-5.14.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.0/ksshaskpass-5.14.0.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.0/ksshaskpass-5.14.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1539121954
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
